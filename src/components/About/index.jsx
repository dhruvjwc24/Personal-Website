  ...
  return (
    <>
      ...
      <div className="flex gap-20 items-start flex-col-reverse md:flex-row-reverse transition-all">
        ...
        >
          <h2 className="text-3xl mb-6 font-display">My name is Dhruv, and I love to build.</h2>
          <p className="text-lg font-light text-neutral-700 dark:text-neutral-300 mb-4">
            I study Computer Science at the University of Michigan, where I’m exploring the intersections of systems computing, data-driven modeling, and machine learning.
            <br /><br />
